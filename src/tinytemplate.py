...
class TinyTemplate:
    ...
    def _handling_global_variables(self):
    ...
    def _template_token_analyze(self):
    ...
    def _if_statement(self, expressions):
    ...
    def _for_statement(self, expressions):
    ...
    def _generate_dot_code(self, expr):
    ...
    def _generate_pipe_code(self, expr):
    ...
    def _generate_var_code(self, expr):
    ...
    def _generate_statement_code(self, expr):
        code = ''
